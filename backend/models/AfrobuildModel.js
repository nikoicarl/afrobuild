const PrivilegeAfrobuild = {
    ...
    */
    columnList: [
        ...
        'add_merchant', 'update_merchant', 'deactivate_merchant', 
        ...
        'view_transaction_report','view_merchant_report',
    ...
    */
    createTableStatement: (`
        ...
        add_merchant VARCHAR(5),
        update_merchant VARCHAR(5),
        deactivate_merchant VARCHAR(5),
        ...
        view_merchant_report VARCHAR(5),
        view_vendor_report VARCHAR(5),

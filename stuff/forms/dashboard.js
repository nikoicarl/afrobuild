        ...
        <div class="col-md-12 mt-3">
            <div class="stat-card afrobuild_transaction_data_table_div">
                <div class="search-wrapper">
                    <input type="text" id="afrobuild_transaction_general_search" class="search-input"
...
function ActionModal() {
    return `
    <button type="button" class="afrobuild_transaction_action_modal hide" data-toggle="modal"
        data-target="#actionModal"></button>
    <div class="modal fade afrobuild_transaction_action_modal" id="actionModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body px-4 py-3">
                    <form class="afrobuild_transaction_action_form">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="message" class="form-control afrobuild_transaction_action_msg" rows="4"
...
function ViewModal() {
    ...
    <button type="button" class="afrobuild_transaction_view_modal hide" data-toggle="modal"
        data-target="#viewModal"></button>

    <!-- View Modal -->
    <div class="modal fade afrobuild_transaction_view_modal" id="viewModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <label class="form-label fw-bold mb-2" style="font-size: 1.1em;">Transaction Items</label>
                            <!-- Table -->
                            <div class="table-responsive">
                                <table id="transaction_table" class="table table-bordered table-striped table-hover"
                                    ...
                                    <tbody class="afrobuild_view_items_table_body">

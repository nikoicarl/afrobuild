...
function customDropzone(dropzoneIdName, dropzoneInputIdName, dropzonePreviewIdName) {
    ...
    dropzonePreview.innerHTML = '<span class="afrobuild_dropzone_title"> Click to upload supporting files/documents such as receipts, invoices etc. here. </span> <br> <span class="afrobuild_dropzone_subtitle text-danger" style="font-size:12px;"> You can select up to 10 files </span>';
    ...
    dropzone.ondragover = function () {
        this.className = 'afrobuild_dropzone afrobuild_dragover';
        return false;
    };

    dropzone.ondragleave = function () {
        this.className = 'afrobuild_dropzone';
        return false;
    };
...
function clearNavigationLoader() {
    $('.afrobuild_progress_bar').attr("style", "width: 100%");
    $('.afrobuild_progress_bar').attr("aria-valuenow", 100);
    setTimeout(() => {
        $('.afrobuild_progress_bar_div').hide();
    }, 500);
}
